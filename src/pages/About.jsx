...
import BannerImage1 from "../assets/Images/about1.jpg"
import BannerImage2 from "../assets/Images/about2.jpg"
import BannerImage3 from "../assets/Images/about3.jpg"
import FoundingStory from "../assets/Images/about4.jpg"
                ...
                <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                    <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
                        ...
                        <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">
                            E-LMS is at the forefront of driving innovation in
                    ...
                    <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
                        <img
                            src={BannerImage2}
                            alt=""
                            className="shadow-[4px_4px_rgba(227,252,3)]"
                        />
                        <img
                            src={BannerImage3}
                            alt=""
                ...
                <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
                    <div className="flex flex-col items-center justify-between gap-10 lg:flex-row">
                        <div className="my-24 flex flex-col gap-10 lg:w-[50%]">
                            ...
                            <p className="text-justify text-base font-medium text-richblack-300 lg:w-[95%]">
                        ...
                        <div className="lg:w-[50%]">
                            <img
                                src={FoundingStory}
                                alt=""
                                className="rounded shadow-[0_0_20px_0] shadow-[#FC6767]"
                            />
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-between lg:flex-row lg:gap-10">
                        <div className="my-24 flex flex-col gap-10 lg:w-[40%]">
                            <h1 className="bg-gradient-to-b from-[#FF512F] to-[#F09819] bg-clip-text text-center text-4xl font-semibold text-transparent">
                                Our Vision
                            </h1>
                            <p className="text-justify text-base font-medium text-richblack-300 lg:w-[95%]">
                        ...
                        <div className="my-24 flex flex-col gap-10 lg:w-[40%]">
                            <h1 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] bg-clip-text text-center text-4xl font-semibold text-transparent">
                                Our Mission
                            </h1>
                            <p className="text-justify text-base font-medium text-richblack-300 lg:w-[95%]">
